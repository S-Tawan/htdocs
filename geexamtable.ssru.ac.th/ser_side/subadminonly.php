...
$q = "SELECT * FROM admin_table  WHERE admin_role ='เจ้าหน้าที่ทั่วไป'";
...
<html>
    ...
    ?>
        ...
        <div class="col col-lg-10" style="border:1px solid #d9d9d9">
                            <center><h3 class="text-info">ผู้ดูแลระบบ</h3></center>
                                                ...
                                                <div class="row">
                                                    <div class="col col-lg-6">
                                                        ...
                                                        <div class="modal fade" id="update_admin_data<?php echo $row['admin_id'] ?>" role="dialog">
                                                            ...
                                                            <p> Password : </p><input type="text" name="password" value="<?php echo $row['admin_password'] ?>">
                                                                                        <br><br>
                                                                                        <p>ระดับ : </p><select class="form-control" name="role"  >
                                                                                                <option>เจ้าหน้าที่ทั่วไป</option>
                                                                                        </select><br>
